  ...
  return (
    <div className='flex flex-wrap '>
      <div className='w-full lg:w-1/2 '>
        ...
        <span className='bg-gradient-to-r from-stone-300 to-stone-600 text-2xl lg:text-5xl tracking-tight text-transparent bg-clip-text'>Full stack developer</span>
      ...
      <div className='flex justify-center mt-[-70px] lg:p-8 lg:mt-[-15px] '>
